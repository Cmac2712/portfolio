...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function handleScroll() {
      ...
      var adjust = 300;
      var scrollEnd = window.scrollY === document.activeElement.offsetHeight + document.activeElement.offsetTop;
      console.log(scrollEnd);
      console.log(scrollY);
      console.log(document.activeElement.offsetHeight + document.activeElement.offsetTop);
...
//# sourceMappingURL=index.js.0db8938cbc61993fa7ac.hot-update.js.map