...
function (_React$Component) {
  ...
  _createClass(Nav, [{
    ...
    key: "setActiveState",
    value: function setActiveState() {//TODO set active steate for selected menu item
    }
  }, {
    key: "handleClick",
    value: function handleClick(link) {
      console.log('clicked');
      this.props.changeSection.bind(null, link.href);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("nav", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", (_React$createElement = {
          ...
          key: i,
          href: link.href,
          onClick: _this2.handleClick.bind(null, link)
        }, _defineProperty(_React$createElement, "onClick", function onClick(event) {
          event.preventDefault();
        }), _defineProperty(_React$createElement, "__source", {
          fileName: _jsxFileName,
          lineNumber: 29
        }), _defineProperty(_React$createElement, "__self", this), _React$createElement), link.name);
      }));
    }
  }]);
...
//# sourceMappingURL=index.js.ee6dbcfed69d7107a1b5.hot-update.js.map