...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function handleScroll() {
      ...
      var adjust = 300;
      var scrollEnd = document.activeElement.offsetHeight === window.scrollY + document.activeElement.offsetTop;
      console.log(scrollY + document.activeElement.offsetHeight);
      console.log(document.activeElement.offsetHeight);
    ...
    value: function componentWillUpdate() {//this.changeSection(this.state.currentSection)
    }
  }, {
    key: "changeSection",
...
//# sourceMappingURL=index.js.1cdf7252374a098509cb.hot-update.js.map