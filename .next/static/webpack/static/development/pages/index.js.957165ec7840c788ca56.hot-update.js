...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function changeSection(href) {
      ...
      console.log(this[href.substr(1) + 'Ref']);
      this.setState({
        currentSection: this[href.substr(1) + 'Ref']
      }); //this.scrollToComponent(this.state.currentSection, { offset: 0, align: 'middle', duration: 500, ease:'inCirc' });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.957165ec7840c788ca56.hot-update.js.map