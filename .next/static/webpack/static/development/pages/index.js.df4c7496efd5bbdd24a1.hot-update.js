    ...
    value: function handleScroll() {
      ...
      this.state.offsets.forEach(function (section) {
        if (pos > section.offset - adjust && _this2.state.currentSection !== section.id) {
          console.log(_this2.state.currentSection);
          console.log('changing to ' + section.id); // this.setState({
...
//# sourceMappingURL=index.js.df4c7496efd5bbdd24a1.hot-update.js.map