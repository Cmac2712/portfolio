...
define(['./notify'], function(Notify) {
	    ...
	    brandColor =  document.styleSheets[0].cssRules[document.styleSheets[0].cssRules.length-1].style.backgroundColor,
	...
	function init() {
	    _draw();
	    document.getElementById('animConfigButton').classList.add('enabled');
	}
